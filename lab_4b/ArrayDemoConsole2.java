/*
 * ArrayDemoConsole2.java
 */
package cs209.lab_04b;

import javax.swing.*;

public class ArrayDemoConsole2 {

    public static void main(String[] args) {
        
        final int LIMIT = 12;       // Max size of array
        int A[] = new int[LIMIT], B[] = new int[LIMIT], C[] = new int[LIMIT];  // Array declaration and creation
        ...
        String outputStr = "", outputStr2 = "", outputStr3 = "";  // String to display output to user
        ...
        {
            C[k] = (A[k] % B[k]); // populate C with values A % B
        } // end of for k
        
        // Display Array C
        outputStr3 = "\nThe number of elements in array C is: " + C.length + "\n"
                + "The elements of array C: " + arrayToString(C, C.length) + "\n"
                + "Sum of elements in Array C: " + arraySum(C);
        System.out.println(outputStr3);
        JOptionPane.showMessageDialog(null,outputStr3,"Array C Data",JOptionPane.INFORMATION_MESSAGE);
        
        // Sort arrays
        insertionSort(A); // sort array A
        insertionSort(B); // sort array B
        insertionSort(C); // sort array C
